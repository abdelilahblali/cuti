          ...
          <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            ...
            <div>
              <div class="btn-wrapper">
                ...
                @endif
                <a href="{{ url('manager_overtimes_calendar') }}" class="btn btn-primary"><i class="mdi mdi-calendar "></i> Calendar</a>
                ...
                <a href="{{ url('manager_overtimes', [ 'act' => '1' ]) }}" class="btn btn-inverse-success"><i class="mdi mdi-calendar "></i> Accepted Overtime</a>
                <a href="{{ url('manager_overtimes', [ 'act' => '-1' ]) }}" class="btn btn-inverse-danger"><i class="mdi mdi-av-timer "></i> Refused Overtime</a>
              </div>
            </div>
