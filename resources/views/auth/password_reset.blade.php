...
<div class="container">
    <div class="row justify-content-center" >
        <div class="col-md-6 col-md-offset-3" style="padding: 20px 30px;" >
            <div class="card" style="background: white; border-radius: 6px; padding: 20px; margin-top: 80px">
                ...
                <h4>Cuti Management</h4>
                <a href="{{ route('home') }}"><img src="{{ url('imgs/logo.png') }}" style="width: 50%; margin-top: 16px"></a>
              </div>
                <hr>
                <div class="card-body">
