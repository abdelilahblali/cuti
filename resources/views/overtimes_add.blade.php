...
<div class="col-md-12 grid-margin stretch-card formular">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Add new overtime request</h4>
        <form method="POST" action="{{ route('overtimes_added') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group">
          ...
          <textarea class="form-control form-control-lg" name="note" style="min-height: 150px;"></textarea>
        </div>
