...
<div class="col-sm-12">
  <div class="home-tab">
    <div class="tab-content tab-content-basic" style="margin-top:-40px">
      <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                      ...
                      <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <div>
                          <div class="btn-wrapper">
                            ...
                            <a href="{{ url('manager_travel', [ 'act' => '0' ]) }}" class="btn btn-otline-dark align-items-center"><i class="mdi mdi-wallet-travel "></i> Business Travel</a>
                            <a href="{{ url('manager_resign', [ 'act' => '0' ]) }}" class="btn btn-otline-dark align-items-center"><i class="mdi mdi-account-arrow-left "></i>Resignation</a>
            ...
            <div class="card-body">
              <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      <div>
                       <h4 class="card-title card-title-dash">Statictic of <?php echo date('Y'); ?></h4>
                     </div>
        ...
        <div class="col-lg-2 grid-margin stretch-card">
          ...
          @if(Auth::user()->img!='')
          <div class="card profil_background" style='background-image: url("{{ url('media/profil/') }}/{{ Auth::user()->img }}"); background-position: center top;'>
          @else
          <div class="card profil_background" style='background-image: url("{{ url('imgs/no-profil_magnitude.jpg') }}");'>
          @endif
        ...
        <div class="col-lg-5 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title card-title-dash">Last Notifications</h4>
        ...
        <div class="col-lg-5 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Last Leaves</h4>
              <div class="table-responsive">
                <table class="table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a title="View" href="{{ route('leave_edit',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-xs btn-success" type="button">View</button></a>
                        @if($item->act==0)
                        <a title="Update" href="{{ route('leave_edit',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-xs btn-success" type="button">Update</button></a>
                        <a title="Delete" href="{{ route('leave_deleted',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-xs btn-danger" type="button" onclick="return confirm('Are you sure to delete this item ?');">Delete</button></a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
        ...
        <div class="col-lg-2 grid-margin stretch-card">
          ...
          <div class="card bg-info card-rounded" style="background:black !important">
            <div class="card-body pb-0">
              <h4 class="card-title card-title-dash text-white mb-4">Status Summary</h4>
              <div class="row">
                <div class="col-sm-12">
                  <p class="status-summary-ight-white mb-1" style="color: white;">Available Day Off</p>
                  <h2 class="text-primary bold" style="color: white !important;">{{ 31 - $sum }}</h2>
                </div>
              </div>
              <div class="row" style="margin-top:7px">
                <div class="col-sm-12">
                  <p class="status-summary-ight-white mb-1" style="color: white;">Total Day Off</p>
                  <h2 class="text-info bold" style="color: white !important;">{{ $sum }}</h2>
                </div>
              </div>
              <div class="row" style="margin-top:7px">
                <div class="col-sm-12">
                  <p class="status-summary-ight-white mb-1" style="color: white;">Overtime of current month</p>
                  <h2 class="text-info bold" style="color: white !important;">{{ $sum_month }}</h2>
                </div>
              </div>
              <div class="row" style="margin-top:7px">
                <div class="col-sm-12">
                  <p class="status-summary-ight-white mb-1" style="color: white;">Total Overtime</p>
                  <h2 class="text-info bold" style="color: white !important;">{{ $sum2 }}</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title card-title-dash">Leaves Summary <?php echo date('Y'); ?></h4>
              <table id="table2" class="table display nowrap" style="width: 100%;">
                ...
                <tbody>
                  ...
                  @for($i=1; $i<=12; $i++)
                    <?php 
                    $nb_jr = Admin::calc_nb_leaves($i, $year); 
                    ...
                    <tr>
                      ...
                      <td class="bold green"><?php echo $days_take; ?></td>

                      <td><?php echo $pourcent; ?>%</td>
                      <td><?php echo $days_take."/".$nb_jr_month; ?></td>
                      <td>
                          <div class="d-flex justify-content-between align-items-center mb-1 max-width-progress-wrap"></div>
                          <div class="progress progress-md">
                            <div class="progress-bar @if($pourcent>50) bg-success @else bg-danger @endif" role="progressbar" style="width: <?php echo $pourcent; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                      </td>
                    </tr>
                  @endfor 
        ...
        <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title card-title-dash">Overtime Summary <?php echo date('Y'); ?></h4>
              <table id="table3" class="table display nowrap" style="width: 100%;">
                <thead>
                  <tr>
                    <th>Month</th>
                    <th>Hours</th>
    ...
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          ...
          datasets: [{
              label: 'Leave',
              data: [
                <?php echo Admin::calc_nb_leaves(1, $year); ?> , 
                <?php echo Admin::calc_nb_leaves(2, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(3, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(4, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(5, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(6, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(7, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(8, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(9, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(10, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(11, $year); ?>, 
                <?php echo Admin::calc_nb_leaves(12, $year); ?>],
            ...
            label: 'Over Time',
            data: [
                <?php echo Admin::calc_nb_overtimes(1, $year); ?> , 
                <?php echo Admin::calc_nb_overtimes(2, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(3, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(4, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(5, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(6, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(7, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(8, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(9, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(10, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(11, $year); ?>, 
                <?php echo Admin::calc_nb_overtimes(12, $year); ?>],
