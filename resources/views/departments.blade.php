        ...
        <table id="table2" class="table display nowrap" style="width: 100%;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a title="Update" href="{{ route('departments_edit',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-success" type="button">Update</button></a>
                <a title="Delete" href="{{ route('departments_deleted',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-danger" type="button" onclick="return confirm('Are you sure to delete this item ?');">Delete</button></a>
              </td>
            </tr>
            @endforeach
          </tbody>
