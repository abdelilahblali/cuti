...
<div class="col-md-12 grid-margin stretch-card formular">
  <div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('overtimes_edited', [ 'ref' => $item->ref ]) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="time" class="form-control form-control-lg" name="to_time" id="to_time" value="{{ $item->to_time }}" required>
            </div>
          </div>
        </div>
