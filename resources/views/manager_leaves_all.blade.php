          ...
          <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            <div>
              <div class="btn-wrapper">
                ...
                <a href="{{ url('manager_leaves', [ 'act' => '0' ]) }}" class="btn btn-primary text-white me-0"><i class="mdi mdi-calendar "></i> Leave</a>
        ...
        <table id="table2" class="table display nowrap" style="width: 100%;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="bold">{{ Admin::usersGetManager($item->cref) }}</td>
              ...
              <td>
                <a title="View" href="{{ route('manager_leaves_show',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-success" type="button">View</button></a>
                <a title="Delete" href="{{ route('manager_leaves_delete',[ 'ref' => $item->ref ]) }}"  onclick="return confirm('Are you sure to delete this element ?');"><button class="btn btn-sm btn-danger" type="button">Delete</button></a>
              </td>
            </tr>
            @endforeach
          </tbody>
