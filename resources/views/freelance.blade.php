        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><p><?php echo wordwrap($item->note,80,"<br>\n"); ?></p></td>
              <td>
              ...
              <td>
                <a title="View" href="{{ route('freelance_edit',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-success" type="button">View</button></a>
              	@if($item->act==0)
                <a title="Update" href="{{ route('freelance_edit',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-success" type="button">Update</button></a>
              	<a title="Delete" href="{{ route('freelance_deleted',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-danger" type="button" onclick="return confirm('Are you sure to delete this item ?');">Delete</button></a>
                @endif
              </td>
            </tr>
            @endforeach
