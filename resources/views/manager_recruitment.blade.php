          ...
          <div class="d-sm-flex align-items-center justify-content-between border-bottom">
            ...
            <div>
              <div class="btn-wrapper">
                ...
                <a href="{{ url('manager_recruitment', [ 'act' => '1' ]) }}" class="btn btn-inverse-success"><i class="mdi mdi-calendar "></i> Accepted Request</a>
                <a href="{{ url('manager_recruitment', [ 'act' => '-1' ]) }}" class="btn btn-inverse-danger"><i class="mdi mdi-av-timer "></i> Refused Request</a>
              </div>
            </div>
        ...
        <table id="table2" class="table display nowrap" style="width: 100%;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a title="View" href="{{ route('manager_recruitment_show',[ 'ref' => $item->ref ]) }}" ><button class="btn btn-sm btn-success" type="button">View</button></a>
                <a title="Delete" href="{{ route('manager_recruitment_delete',[ 'ref' => $item->ref ]) }}"  onclick="return confirm('Are you sure to delete this element ?');"><button class="btn btn-sm btn-danger" type="button">Delete</button></a>
                @if($item->act==1)
